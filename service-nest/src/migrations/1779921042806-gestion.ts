...
export class Gestion1779921042806 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "sucursal" ("id" SERIAL NOT NULL, "nombre" character varying(100) NOT NULL, "ciudad" character varying(50) NOT NULL, "activo" boolean NOT NULL DEFAULT true, CONSTRAINT "PK_a3817e81fd6972dd2172d9c4e60" PRIMARY KEY ("id"))`);
