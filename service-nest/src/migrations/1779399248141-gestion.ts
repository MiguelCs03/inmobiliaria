...
export class Gestion1779399248141 implements MigrationInterface {
    name = 'Gestion1779399248141'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "factura" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "contrato_id" uuid NOT NULL, "nro_factura" character varying(30) NOT NULL, "monto_total" numeric(12,2) NOT NULL, "fecha_emision" TIMESTAMP NOT NULL, CONSTRAINT "UQ_26babef3ce3453fd7cc4eff9d2b" UNIQUE ("nro_factura"), CONSTRAINT "PK_ca804984009ea42a7b46adb9a86" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "contrato" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "propiedad_id" uuid NOT NULL, "cliente_id" uuid NOT NULL, "empleado_id" uuid NOT NULL, "monto_total" numeric(12,2) NOT NULL, "documento_nosql_id" character varying(50), CONSTRAINT "PK_b82cfcedf2037eab18ca2714ef9" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "propiedad" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "propietario_id" uuid NOT NULL, "tipo_propiedad_id" integer NOT NULL, "tipo_operacion_id" integer NOT NULL, "estado_propiedad_id" integer NOT NULL, "precio_base" numeric(12,2) NOT NULL, "area_m2" numeric(10,2) NOT NULL, "detalles_json" jsonb, CONSTRAINT "PK_78e6c440a5d7863829c61e23f41" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "factura" ADD CONSTRAINT "FK_097a69982394a18f677f82015d5" FOREIGN KEY ("contrato_id") REFERENCES "contrato"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "factura" DROP CONSTRAINT "FK_097a69982394a18f677f82015d5"`);
