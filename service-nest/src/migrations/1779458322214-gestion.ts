...
export class Gestion1779458322214 implements MigrationInterface {
    name = 'Gestion1779458322214'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "propietario" ("id" BIGSERIAL NOT NULL, "nombres" character varying(100) NOT NULL, "telefono" character varying(20) NOT NULL, "ci_nit" character varying(30) NOT NULL, CONSTRAINT "PK_97b6ca7c3a5c40768ec179ad73b" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "propiedad_imagen" ("id" BIGSERIAL NOT NULL, "propiedad_id" bigint NOT NULL, "url_s3" character varying(255) NOT NULL, "procesada_ia" boolean NOT NULL DEFAULT false, CONSTRAINT "PK_09dbc7be1b810b8487df60e5710" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "usuario" ("id" BIGSERIAL NOT NULL, "rol_id" integer NOT NULL, "correo" character varying(150) NOT NULL, "contrasenia_hash" character varying(255) NOT NULL, "activo" boolean NOT NULL DEFAULT true, CONSTRAINT "UQ_349ecb64acc4355db443ca17cbd" UNIQUE ("correo"), CONSTRAINT "PK_a56c58e5cabaa04fb2c98d2d7e2" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "cliente" ("id" BIGSERIAL NOT NULL, "usuario_id" bigint, "nombres" character varying(100) NOT NULL, "telefono" character varying(20) NOT NULL, "ci_nit" character varying(30) NOT NULL, CONSTRAINT "REL_51a4d9370abe0523f208ef3f43" UNIQUE ("usuario_id"), CONSTRAINT "PK_18990e8df6cf7fe71b9dc0f5f39" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "visita" ("id" BIGSERIAL NOT NULL, "propiedad_id" bigint NOT NULL, "cliente_id" bigint NOT NULL, "empleado_id" bigint NOT NULL, "fecha_visita" TIMESTAMP NOT NULL, CONSTRAINT "PK_8ffe9de9ae8f45fbeaaea4d5552" PRIMARY KEY ("id"))`);
